...
#include "user/inc/user_config.h"
    ...
    && defined(CAM_IO_D1) && defined(CAM_IO_D2) && defined(CAM_IO_D3)                \
    && defined(CAM_IO_D4) && defined(CAM_IO_D5) && defined(CAM_IO_D6)                \
    && defined(CAM_IO_D7) && defined(CAM_IO_RESET_PORT) && defined(CAM_IO_RESET_PIN) \
    && defined(CAM_IO_PWDN_PORT) && defined(CAM_IO_PWDN_PIN)                          \
    && defined(CAM_IO_LIGHT_PORT) && defined(CAM_IO_LIGHT_PIN)                        \
    && defined(CAM_SCCB_I2C_PORT) && defined(CAM_XCLK_EXTERNAL_OSC)                   \
    && defined(CAM_XCLK_EXTERNAL_HZ) && defined(CAM_IO_XCLK)
#define BF20A6_CAM_AVAILABLE (1)
#else
#define BF20A6_CAM_AVAILABLE (0)
#endif
