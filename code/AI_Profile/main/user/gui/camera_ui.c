...
lv_obj_t* camera_create_screen(lv_obj_t* parent, lv_coord_t area_w, lv_coord_t area_h,
    ...
    if (s_camera_runtime.task_handle != NULL) {
        vTaskDelete(s_camera_runtime.task_handle);
    ...
    BaseType_t task_ok =
        xTaskCreate(_camera_ui_task, "camera_ui", CAMERA_UI_TASK_STACK_SIZE, &s_camera_runtime, 5,
