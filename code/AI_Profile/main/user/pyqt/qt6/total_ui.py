...
"}")
        ...
        self.knob_overlay = QtWidgets.QWidget(parent=self.knob_frame)
        self.knob_overlay.setMinimumSize(QtCore.QSize(136, 136))
        self.knob_overlay.setMaximumSize(QtCore.QSize(136, 136))
        self.knob_overlay.setObjectName("knob_overlay")
        self.knob_overlay_layout = QtWidgets.QGridLayout(self.knob_overlay)
        ...
        self.angle_knob = QtWidgets.QDial(parent=self.knob_overlay)
        ...
        self.knob_value_lab = QtWidgets.QLabel(parent=self.knob_overlay)
